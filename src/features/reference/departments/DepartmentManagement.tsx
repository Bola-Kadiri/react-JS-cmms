// src/features/accounts/departments/DepartmentManagement.tsx
...
import { useDepartmentsQuery, useDeleteDepartment } from '@/hooks/department/useDepartmentQueries';
...
const DepartmentManagement = () => {
  ...
  const handleAddDepartment = () => {
    navigate('/dashboard/accounts/departments/create');
  };

  const handleViewDepartment = (id: string) => {
    navigate(`/dashboard/accounts/departments/view/${id}`);
  };
