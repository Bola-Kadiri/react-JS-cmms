...
const BankaccountDetailView = () => {
    ...
    return (
      <div className="flex justify-center items-center h-64">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-muted-foreground">{t('bankAccount.detail.loading')}</p>
        </div>
      </div>
    );
  }
  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center justify-center h-64 gap-4">
        ...
        <div className="text-red-500 text-xl">{t('bankAccount.detail.error')}</div>
        <p className="text-sm text-muted-foreground mb-4">
          {error instanceof Error ? error.message : t('bankAccount.detail.unknownError')}
        </p>
        <Button onClick={handleBack} variant="outline">
          {t('bankAccount.detail.backToList')}
        </Button>
      </div>
    );
  }
  ...
  if (!bankaccount) {
    return (
      <div className="flex flex-col items-center justify-center h-64 gap-4">
        <AlertTriangle className="h-12 w-12 text-red-500" />
        <div className="text-red-500 text-xl">{t('bankAccount.detail.notFound')}</div>
        <Button onClick={handleBack} variant="outline">
          {t('bankAccount.detail.backToList')}
        </Button>
      </div>
    ...
    <div className="container mx-auto py-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <Button onClick={handleEdit} className="rounded-full shadow-sm bg-green-600 hover:bg-green-700">
          <Edit className="mr-2 h-4 w-4" /> {t('bankAccount.detail.editAccount')}
        </Button>
        </PermissionGuard>
      </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-100 mt-1 flex items-center gap-2">
                    <CreditCard className="h-4 w-4" /> {t('bankAccount.detail.accountNumberLabel', { number: bankaccount.account_number })}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-lg font-semibold mb-4 flex items-center gap-2 text-gray-800">
                    ...
                    {t('bankAccount.detail.cardTitle')}
                  </h3>
                  ...
                  <div className="space-y-6">
                    <div className="bg-gray-50 rounded-xl p-4 flex items-start gap-4 transition-all duration-200 hover:bg-gray-100 hover:shadow-md">
                      ...
                      <div>
                        <p className="text-sm text-gray-500 mb-1">{t('bankAccount.detail.fields.accountName')}</p>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 flex items-start gap-4 transition-all duration-200 hover:bg-gray-100 hover:shadow-md">
                      ...
                      <div>
                        <p className="text-sm text-gray-500 mb-1">{t('bankAccount.detail.fields.accountNumber')}</p>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 flex items-start gap-4 transition-all duration-200 hover:bg-gray-100 hover:shadow-md">
                      ...
                      <div>
                        <p className="text-sm text-gray-500 mb-1">{t('bankAccount.detail.fields.bankName')}</p>
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-lg font-semibold mb-4 flex items-center gap-2 text-gray-800">
                    ...
                    {t('bankAccount.detail.additionalSection')}
                  </h3>
                  ...
                  <div className="space-y-6">
                    <div className="bg-gray-50 rounded-xl p-4 flex items-start gap-4 transition-all duration-200 hover:bg-gray-100 hover:shadow-md">
                      ...
                      <div>
                        <p className="text-sm text-gray-500 mb-1">{t('bankAccount.detail.fields.currency')}</p>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 flex items-start gap-4 transition-all duration-200 hover:bg-gray-100 hover:shadow-md">
                      ...
                      <div>
                        <p className="text-sm text-gray-500 mb-1">{t('bankAccount.detail.fields.address')}</p>
                        <p className="text-base">{bankaccount.address || t('bankAccount.detail.noAddress')}</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
                      <div className="p-5 bg-gray-50 border-b border-gray-200">
                        <div className="flex justify-between items-center">
                          <h4 className="font-medium text-gray-800">{t('bankAccount.detail.accountStatus')}</h4>
                          {getStatusBadge(bankaccount.status)}
                        </div>
                      </div>
                      ...
                      <div className="p-5">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <span className="font-medium text-gray-800">{t('bankAccount.detail.activeAccount')}</span>
                        </div>

                        <p className="text-sm text-gray-600">
                          {t('bankAccount.detail.activeAccountDesc')}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <Card className="border border-gray-200">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-lg flex items-center gap-2">
                      ...
                      {t('bankAccount.detail.accountDetails')}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
