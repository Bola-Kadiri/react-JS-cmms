...
const SubsystemDetailView = () => {
    ...
    return (
      <div className="flex justify-center items-center h-64">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-muted-foreground">{t('subsystem.detail.loading')}</p>
        </div>
      </div>
    );
  }
  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center justify-center h-64 gap-4">
        <div className="text-red-500 text-xl">{t('subsystem.detail.error')}</div>
        <p className="text-sm text-muted-foreground mb-4">
          {error instanceof Error ? error.message : t('subsystem.detail.errorFallback')}
        </p>
        <Button onClick={handleBack} variant="outline">
          {t('subsystem.detail.backButton')}
        </Button>
      </div>
    );
  }
  ...
  if (!subsystem) {
    return (
      <div className="flex flex-col items-center justify-center h-64 gap-4">
        <div className="text-red-500 text-xl">{t('subsystem.detail.notFound')}</div>
        <Button onClick={handleBack} variant="outline">
          {t('subsystem.detail.backButton')}
        </Button>
      </div>
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-800">{t('subsystem.detail.title')}</h1>
              <p className="text-gray-600 mt-1">{t('subsystem.detail.subtitle')}</p>
            </div>
          </div>
          <Button
            onClick={handleEdit}
          ...
          >
            <Edit className="mr-2 h-4 w-4" /> {t('subsystem.detail.editButton')}
          </Button>
        </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="text-sm font-medium text-gray-600">{t('subsystem.detail.idLabel')} {subsystem.id}</span>
                  </div>
                </div>
              </div>
            </CardHeader>
            ...
            <CardContent className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold text-gray-800">{t('subsystem.detail.subsystemInfo')}</h3>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-500 uppercase tracking-wide">{t('subsystem.detail.subsystemId')}</p>
                    ...
                    <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-500 uppercase tracking-wide">{t('subsystem.detail.subsystemName')}</p>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold text-gray-800">{t('subsystem.detail.associatedBuilding')}</h3>
                  </div>
                    ...
                    {subsystem.building_detail && (
                      <>
                        <div className="flex items-start gap-4 p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                          ...
                          <div>
                            <p className="text-sm font-medium text-blue-700 uppercase tracking-wide">{t('subsystem.detail.buildingName')}</p>
                        ...
                        <div className="flex items-start gap-4 p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                          ...
                          <div>
                            <p className="text-sm font-medium text-purple-700 uppercase tracking-wide">{t('subsystem.detail.buildingCode')}</p>
                            <p className="text-lg font-semibold text-purple-800 mt-1">{subsystem.building_detail.code}</p>
                            <p className="text-xs text-purple-600 mt-1">{t('subsystem.detail.buildingIdLabel')} {subsystem.building_detail.id}</p>
                          </div>
                        </div>
                      </>
                    )}
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800">{t('subsystem.detail.timestamps')}</h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-4 p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                    ...
                    <div>
                      <p className="text-sm font-medium text-green-700 uppercase tracking-wide">{t('subsystem.detail.createdAt')}</p>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors">
                    ...
                    <div>
                      <p className="text-sm font-medium text-orange-700 uppercase tracking-wide">{t('subsystem.detail.updatedAt')}</p>
          ...
          <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 h-fit">
            <CardHeader className="bg-gradient-to-r from-gray-50 to-gray-100 border-b">
              <CardTitle className="text-xl font-bold text-gray-800 flex items-center gap-2">
                ...
                {t('subsystem.detail.quickActions')}
              </CardTitle>
            </CardHeader>
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                <Button
                  ...
                  size="lg"
                >
                  <Edit className="mr-2 h-5 w-5" /> {t('subsystem.detail.editButton')}
                </Button>
                ...
                <Button
                  ...
                  size="lg"
                >
                  <ArrowLeft className="mr-2 h-5 w-5" /> {t('subsystem.detail.backToList')}
                </Button>
              </div>
              ...
              <div className="text-center">
                <p className="text-sm text-gray-500 mb-2">{t('subsystem.detail.infoLabel')}</p>
                <div className="bg-gradient-to-r from-primary/10 to-primary/5 p-4 rounded-lg">
                  <p className="text-2xl font-bold text-primary">{subsystem.name}</p>
                  <p className="text-sm text-gray-600 mt-1">{t('subsystem.detail.idLabel')} {subsystem.id}</p>
                  {subsystem.building_detail && (
