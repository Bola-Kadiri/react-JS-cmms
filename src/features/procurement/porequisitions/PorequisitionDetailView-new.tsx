    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <PermissionGuard feature='po_requisition' permission='edit'>
            <Button
              onClick={handleEdit}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {porequisition.attachment_data && porequisition.attachment_data.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Paperclip className="h-5 w-5 text-emerald-600" />
                  Attachment Documents ({porequisition.attachment_data.length})
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  {porequisition.attachment_data.map((attachment: any, index: number) => (
                    <div
                      key={index}
